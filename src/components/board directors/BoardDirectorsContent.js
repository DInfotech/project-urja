...
const cardDirectorsData = [
    {
        ...
        detail: "He plays an instrumental role in the Marketing and Sales Development of the Company. He has been successful while associating the Company with the worthy projects to the credits of the Company viz. PEC Ltd, Mecon Ltd, etc. Mr. Goyal is holding a Master’s Degree in Commerce."
    },
    {
        id: 2,
    ...
    },
    {
        ...
        detail: "Mrs. Sharma holds Independent Directorship in the Company. She guides the board for adopting Good Governance practices and updation of the recent legal updations. She is a law Graduate and the Member of Institute of Company Secretaries of India."
    },
    {
        id: 4,
        name: "Mr. P. C. Das",
    ...
    }, ,
    {
        ...
        designation: "Independent Director",
        detail: "Mr. Mohlay holds Independent Directorship in the Company. He guides the board for adopting Audit and Finance Policies. He is the Member of Institute of Chartered Accountants of India."
    },
  ];
  ...
  const CardList = () => {
    ...
    <>
        {cardDirectorsData.map(cardDirector => {
          return <CardListItem cardDirector={cardDirector} key={cardDirector.id} />;
        })}
        </>
