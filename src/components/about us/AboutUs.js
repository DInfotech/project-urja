    ...
    <div>
      <div className="mainsection">
        <div className="firstcontainer">
          <div>
            <h3 className="mainheading">Urja Global Limited</h3>
            <hr width="60px" height="2px" color="#fe7701" />
            <h5 className="subheading">
              <b>One of India’s leading Renewable Energy developers.</b>
            </h5>
          </div>
          <p>
            ...
            off-grid and grid connected Solar Power Plants. We are approved
            Channel Partners of Ministry of New and Renewable Energy (MNRE),
            Govt. of India.
          </p>
        </div>
        <div className="secondcontainer">
          <div className="scon">
            ...
            <p>
              ...
              which makes use of green and clean energy simple viz. Solar Home
              Lighting Systems,
            </p>
          </div>
          <div className="scont">
        ...
        <div className="thirdcontainer">
          <p>
            Solar Lanterns, Solar Street Lighting Systems, Roof Top Systems,
